...
import '../animate.css';
import '../styles.css';
import { ProvinceInputContainer } from './province-input';
import { SalaryInputContainer } from './salary-input';
    ...
    render() {
        return (
            <div className='main-container'>
                ...
                <ProvinceInputContainer label='Select your province' type='select'/>
                <SalaryInputContainer label='Enter your annual salary' type='text'/>
                <ErrorMessage />
